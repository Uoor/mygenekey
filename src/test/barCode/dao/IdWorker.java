...
1.按照时间序列往上加，(42(毫秒)+5(机器ID)+5(业务编码)+12(重复累加))，生成的编码 很相似
		需要的是，随机性比较重的

2.这个或许同 糯米的 阿童木，生成唯一编码相同
...
public class IdWorker {
	...
	private final long workerId; //机器节点
	// 数据标识id部分
	private final long datacenterId; //数据中心节点
	...
	public static void main(String[] args) {
		...
		System.out.println(id.datacenterId); //1个不变 ？？
		System.out.println(id.workerId);	//随机变化 ？？
