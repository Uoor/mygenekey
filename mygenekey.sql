...
--
create DATABASE if not exists `mygenekey`;
use `mygenekey`;
...
`refusetime` datetime DEFAULT NULL,
`endtime` datetime DEFAULT NULL,
`supplytime` datetime DEFAULT NULL,
`balance` int(11) DEFAULT NULL,
`paymenttype` int(11) DEFAULT NULL,
`accountnumber` long DEFAULT NULL,
`paymenttype` int(11) DEFAULT NULL,
...
INSERT INTO `logisticscompany` VALUES (1,'顺丰物流'),(2,'申通物流'),(3,'圆通物流');
